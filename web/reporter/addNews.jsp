                                    ...
                                    <div class="row">
                                        ...
                                        <jsp:setProperty name="news" property="*"></jsp:setProperty>
                                            <form action="../NewsController?op=add" method="post" enctype="multipart/form-data">
                                                <img src="../Media/product.jpg" style="width:200px; height: 200px;" id="preview" class="form-control"/> <br/>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <%
                                                            ...
                                                            ArrayList<News_category> categories = cd.getAllNews_category();
                                                            for (News_category cat : categories) {%> 
                                                        <input type="checkbox" name="category" value="<%=cat.getCat_id()%>" /> <%=cat.getName()%> 
                                                        <%}%>
                                                    </td>
                                                </tr>
