...
<%@page contentType="text/html" pageEncoding="UTF-8" import="java.sql.*,com.daos.NewsDao,com.daos.SubscribersDao,com.beans.Subscriber,com.beans.News,com.beans.Reporter,com.daos.ReporterDao"%>
<!DOCTYPE html>
<html lang="en">
