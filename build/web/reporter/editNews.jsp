...
<%@page import="com.daos.News_categoryDao"%>
<%@page import="com.beans.News_category"%>
<%@page contentType="text/html" pageEncoding="UTF-8" import="com.beans.News,java.util.ArrayList"%>
<!DOCTYPE html>
<html>
    <head>
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <%
                                            ...
                                            ArrayList<News_category> catids = new ArrayList();
                                            catids = ndo.getNewsCategoryById(id);
                                            for (News_category c : catids) {
                                                cat += c.getName() + ",";
                                            }
                                            ...
                                            <table class="table">
                                                <br>   <tr><th> <colspan="2"><center><h2>Edit News Here </h2></center></th></tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <%
                                                                News_categoryDao cd = new News_categoryDao();
                                                                ArrayList<News_category> categories = new ArrayList();
                                                                categories = cd.getAllRecords();
                                                            for (News_category cate : categories) {%>
                                                            <input type="checkbox" name="category" value="<%=cate.getCat_id()%>" 
