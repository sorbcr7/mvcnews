...
<%@page contentType="text/html" pageEncoding="UTF-8" import="java.sql.*,com.daos.NewsDao,com.beans.*,java.util.ArrayList"%>
<!DOCTYPE html>
<html>
    <head>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <%
                            ...
                            ArrayList<News_category> category = new ArrayList();
                            category = ndo.getNewsCategory();
                            for (News_category cat : category) {%>
                        <option value="<%=cat.getCat_id()%>"><%=cat.getName()%><br/>
